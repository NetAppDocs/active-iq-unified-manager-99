...
+
See link:concept_cluster_components_and_why_they_can_be_in_contention.md#[Cluster components and why they can be in contention] for a description of the components that are displayed here.
