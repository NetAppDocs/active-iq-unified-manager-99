...
. link:task-configuring-event-notification-settings.[Configure event notification settings]
+
...
. link:task-enabling-remote-authentication.adoc[Enable remote authentication]
+
...
. link:task-adding-users.adoc[Add users]
+
...
. link:task-adding-alerts.adoc[Add alerts]
+
