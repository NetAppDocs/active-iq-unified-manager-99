---
permalink: online-help/reference_dynamic_performance_event_chart_details.html
sidebar: sidebar
keywords: 
...
For more information about the dynamic performance thresholds, see link:reference_performance_event_analysis_and_notification.md#[What events are]. For information about how Unified Manager ranks the workloads and determines the sort order, see xref:concept_how_unified_manager_determines_the_performance_impact_for_an_incident.adoc[How Unified Manager determines the performance impact for an event].
