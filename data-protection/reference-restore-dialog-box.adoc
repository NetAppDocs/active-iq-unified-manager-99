...
xref:task-restoring-data-using-the-health-volumes-page.adoc[Restoring data using the Health: All Volumes view]

xref:task-restoring-data-using-the-health-volume-details-page.adoc[Restoring data using the Volume / Health details page]
