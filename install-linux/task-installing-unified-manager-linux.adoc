...
Access the web UI to change the default password of the umadmin user, and perform the initial setup of Unified Manager, as described in the link:../config/task-using-the-maintenance-console.html[Using the maintenance console].
